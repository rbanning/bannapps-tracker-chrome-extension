...
var require_table = __commonJS({
  "node_modules/airtable/lib/table.js"(exports, module2) {
    ...
    var Table2 = function() {
      ...
      Table3.prototype._listRecords = function(limit, offset, opts, done) {
        var _this = this;
        if (!done) {
          done = opts;
          opts = {};
...
// functions/services/airtable-base.service.ts
var import_airtable = __toModule(require_airtable());
var AirtableBaseService = class {
  constructor(tableName, modelBuilder) {
    this.tableName = tableName;
    this.modelBuilder = modelBuilder;
    this.base = new import_airtable.default({ apiKey: process.env.AT_API }).base(process.env.AT_BASE);
    if (!this.base) {
      throw new Error("AirtableService: Could not connect to base");
    }
    this.table = this.base(tableName);
  }
  async find(id) {
    return await this.table.find(id).then((resp) => {
  ...
  async getAll(config) {
    return await this.table.select(config).all().then((resp) => {
      return this.postGetterMultiple(resp);
    });
  }
  async create(data) {
    return await this.table.create(data).then((resp) => {
      return this.postGetterSingle(resp);
    });
  }
  ...
  postGetterMultiple(resp) {
    if (Array.isArray(resp)) {
      return resp.map((obj) => this.postGetterSingle(obj));
    }
    return null;
  }
};
...
AuthService.TOKEN_ALG = process.env.TOKEN_ALG;
AuthService.AUTH_KEY = process.env.AUTH_KEY;
...
var RequestHelper = class {
  ...
  get identity() {
    return this.isAuthenticated() ? this._identity : null;
  }
  get httpMethod() {
...
var ResponseHelper = class {
  ...
  constructor(resp) {
    ...
    if (resp) {
      ...
      this.result = (_b = resp.body) == null ? void 0 : _b.result;
  ...
  clone(resp) {
    this.statusCode = resp == null ? void 0 : resp.statusCode;
    this.message = resp == null ? void 0 : resp.message;
    this.result = resp == null ? void 0 : resp.result;
  ...
  setNegativeResp(statusCode, message, error) {
    this.setResp(statusCode, message, void 0, error);
  }
  setResp(statusCode, message, result, error) {
    this.statusCode = statusCode;
    this.message = message;
...
var handler = async (event, context) => {
  ...
  switch (httpMethod) {
    case "POST":
      ...
      } else if (((_a = req.requestPath.params) == null ? void 0 : _a.id) === "refresh") {
